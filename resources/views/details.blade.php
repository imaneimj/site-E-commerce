...
<main class="pt-90">
    ...
    <a href="{{route('wishlist.index')}}" class="menu-link menu-link_us-s add-to-wishlist filled-heart">
...
@else
    <form method="POST" action="{{ route('wishlist.add') }}" class="d-inline">
        ...
        <button type="submit" class="menu-link menu-link_us-s add-to-wishlist bg-transparent border-0">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <use href="#icon_heart" />
            </svg>
